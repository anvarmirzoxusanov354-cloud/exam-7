    ...
    <div className="pb-6 bg-white">
      ...
      <div className="max-w-[820px]">
        ...
        <div className="mb-7">
          ...
          <input
            type="text"
            placeholder="Uyga vazifa mavzusini kiriting..."
            value={subject}
            onChange={e => setSubject(e.target.value)}
            className="w-full px-4 py-3 bg-white border-[1.5px] border-[#e5e7eb] rounded-[10px] text-[13.5px] text-[#1a1a2e] outline-none focus:border-[#7c4dff] transition-colors placeholder-[#9ca3af]"
          />
        </div>
